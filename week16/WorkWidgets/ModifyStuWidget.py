...
class ModifyStuStatusWidget(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.radio_button_change.setStyleSheet(
            """
                QRadioButton
                {
                    font : 22px Arial;
        ...
        self.radio_button_add.setStyleSheet(
            """
                QRadioButton
                {
                    font : 22px Arial;
        ...
        self.combo_box_score.setStyleSheet(
            """
                QComboBox
                {
                    font : 22px Arial;
    ...
    def send_action(self):
        if self.result_status == "OK":
            if self.modify_stu_status_widget.radio_status == False:
                ...
                student_list['scores_dict'] = json.dumps(subject_dict)
