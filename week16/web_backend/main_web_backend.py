...
from WebService.DeleteStudentHandler import DeleteStudentHandler
from WebService.ModifyStudentHandler import ModifyStudentHandler
from WebService.ShowStudentHandler import ShowStudentHandler
    ...
    def init_server_application(self):
        return tornado.web.Application(
            [
                ...
                (r"/delete_student", DeleteStudentHandler),
                (r"/modify_student", ModifyStudentHandler),
                (r"/show_student", ShowStudentHandler),
